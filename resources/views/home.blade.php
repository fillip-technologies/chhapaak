    ...
    <nav class="fixed top-0 w-full z-50 glass-header" id="main-nav">
        <div class="flex justify-between items-center px-8 py-6 max-w-screen-2xl mx-auto">
            <a class="font-serif text-2xl font-semibold italic text-white mix-blend-difference" href="/"><img
                    alt="Chhapaak Resort" class="h-10" src="/assets/images/Chhapaak.png" /></a>
            ...
            <button
                class="border border-white text-white px-8 py-2 rounded-full font-label text-[10px] tracking-[0.2em] uppercase hover:bg-white hover:text-primary transition-all duration-500 backdrop-blur-sm">
                Contact
            </button>
        </div>
    </nav>
            ...
            <div class="space-y-32">
                ...
                <div class="flex flex-col md:flex-row-reverse items-center gap-16">
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <button
                            class="bg-secondary-container text-on-secondary-container px-8 py-3 rounded-full font-label text-sm tracking-widest uppercase hover:brightness-95 transition-all">Reserve
                            a Table</button>
                    </div>
                </div>
            </div>
