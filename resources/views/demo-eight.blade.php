...
<body
    class="bg-background text-on-surface font-body selection:bg-primary-fixed selection:text-on-primary-fixed antialiased">
    <!-- TopNavBar -->
    <nav
        class="fixed top-0 w-full z-50 bg-white/80 dark:bg-stone-900/80 backdrop-blur-xl shadow-sm dark:shadow-none transition-all duration-300">
    ...
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center px-6 max-w-4xl">
            <span
                ...
                Redefined</span>
            <h1 class="font-headline text-6xl md:text-9xl text-white mb-8 leading-[1.1] italic">Where Nature <br /><span
                    class="not-italic font-bold">Meets Luxury</span></h1>
            <p class="font-body text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center">
                ...
                <a class="inline-flex items-center border border-white/30 text-white backdrop-blur-md px-10 py-4 rounded-full font-label text-sm tracking-widest uppercase hover:bg-white/10 transition-all"
                    href="#film-section">
                    Watch Film
                </a>
            </div>
    ...
    <!-- New Film Section -->
    <section class="relative py-0 bg-primary overflow-hidden" id="film-section">
        <div class="w-full aspect-video md:h-[90vh] relative group cursor-pointer overflow-hidden">
            <img alt="Cinematic Film Thumbnail"
                class="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-105"
                data-alt="Cinematic wide shot of the resort at sunset, with golden light reflecting on the water"
            ...
            <div class="absolute inset-0 video-overlay flex items-center justify-center flex-col gap-8">
                <div class="relative">
                    <div class="absolute inset-0 bg-white rounded-full animate-ping opacity-25 scale-150"></div>
                    <button
                        class="relative w-24 h-24 md:w-32 md:h-32 bg-white/10 backdrop-blur-xl border border-white/30 rounded-full flex items-center justify-center text-white transition-all duration-500 group-hover:scale-110 group-hover:bg-white group-hover:text-primary">
                        <span class="material-symbols-outlined text-5xl md:text-7xl !fill-1">play_arrow</span>
                    </button>
                </div>
                <div class="text-center text-white px-6">
                    <span class="font-label tracking-[0.4em] uppercase text-xs mb-2 block opacity-70">Experience the
                        Ambience</span>
                    <h2 class="font-headline text-3xl md:text-5xl italic">A Glimpse into Paradise</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-32 bg-surface-container-low" id="rooms">
        <div class="max-w-screen-2xl mx-auto px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                <div class="max-w-2xl">
                    <span class="font-label text-primary tracking-[0.3em] uppercase text-sm mb-4 block">Personal
                        Havens</span>
                    <h2 class="font-headline text-5xl md:text-7xl text-primary mb-6">Unrivaled Sanctuaries</h2>
                ...
                <a class="text-primary font-label text-sm tracking-widest uppercase border-b-2 border-primary/20 pb-2 hover:border-primary transition-all mb-4"
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                <!-- Large Feature Card -->
                <div
                    class="md:col-span-8 group relative overflow-hidden rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-xl transition-shadow duration-500">
                    ...
                    <div class="p-8">
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <div class="text-right">
                                ...
                                <span class="font-headline text-3xl text-primary">$1,200/night</span>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- Side Card 1 -->
                <div
                    class="md:col-span-4 group relative overflow-hidden rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-xl transition-shadow duration-500">
    ...
    <section class="py-32 bg-surface overflow-hidden" id="experiences">
        <div class="max-w-7xl mx-auto px-8">
            <div class="text-center mb-24">
                <span class="inline-block text-primary font-label tracking-[0.3em] uppercase mb-4 text-sm">Curated
                    Moments</span>
                <h2 class="font-headline text-5xl md:text-8xl text-primary italic">Soulful Experiences</h2>
            </div>
            <div class="space-y-40">
                ...
                <div class="flex flex-col md:flex-row items-center gap-20">
                    <div class="w-full md:w-1/2 relative">
                        <div
                            class="absolute -top-10 -left-10 w-64 h-64 bg-secondary-fixed/30 rounded-full blur-3xl -z-10">
                        </div>
                        <img alt="Spa treatment"
                            class="rounded-xl shadow-2xl relative z-10 w-full object-cover aspect-[4/5]"
                            data-alt="Serene spa setting with candles and massage stones"
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <ul class="grid grid-cols-2 gap-6 mb-12">
                            <li class="flex items-center gap-3 text-primary font-medium">
                                <span class="material-symbols-outlined text-secondary">eco</span> Deep Tissue Therapy
                            </li>
                            <li class="flex items-center gap-3 text-primary font-medium">
                                <span class="material-symbols-outlined text-secondary">water_drop</span> Seaweed Wraps
                            </li>
                            <li class="flex items-center gap-3 text-primary font-medium">
                                <span class="material-symbols-outlined text-secondary">self_improvement</span> Sunset
                                Meditation
                            </li>
                            <li class="flex items-center gap-3 text-primary font-medium">
                                <span class="material-symbols-outlined text-secondary">waves</span> Hydrotherapy
                            </li>
                        </ul>
                        <button
                            class="bg-secondary-container text-on-secondary-container px-10 py-4 rounded-full font-label text-sm tracking-widest uppercase hover:brightness-95 transition-all">Explore
                            Treatments</button>
                    </div>
                </div>
                <!-- Experience 2: Dining (Asymmetric Reverse) -->
                <div class="flex flex-col md:flex-row-reverse items-center gap-20">
                    <div class="w-full md:w-1/2 relative">
                        <div
                            class="absolute -bottom-10 -right-10 w-64 h-64 bg-tertiary-fixed/30 rounded-full blur-3xl -z-10">
                        </div>
                        <img alt="Gourmet Dining"
                            class="rounded-xl shadow-2xl relative z-10 w-full object-cover aspect-[4/5]"
                            data-alt="Exquisite plate of seafood at a beachside restaurant"
                    ...
                    <div class="w-full md:w-1/2">
                        <span class="font-label text-primary tracking-[0.3em] uppercase text-sm mb-4 block">The
                            Palette</span>
                        ...
                        <div class="flex flex-col gap-6 mb-12">
                            <div class="p-8 bg-surface-container-low rounded-xl border-l-4 border-primary/20">
                                <h4 class="font-headline text-2xl text-primary mb-2">The Reef Kitchen</h4>
                                <p class="text-on-surface-variant text-base">Signature seafood and sunset cocktails</p>
                            </div>
                            <div class="p-8 bg-surface-container-low rounded-xl border-l-4 border-primary/20">
                                <h4 class="font-headline text-2xl text-primary mb-2">Sandbar Grill</h4>
                                <p class="text-on-surface-variant text-base">Casual barefoot dining and wood-fired
                                    pizzas</p>
                            </div>
                        </div>
                        <button
                            class="bg-secondary-container text-on-secondary-container px-10 py-4 rounded-full font-label text-sm tracking-widest uppercase hover:brightness-95 transition-all">Reserve
                            a Table</button>
                    </div>
                </div>
            </div>
    ...
    <section class="py-32 bg-surface-container-low" id="gallery">
        <div class="max-w-screen-2xl mx-auto px-8">
            <h2 class="font-headline text-5xl md:text-7xl text-primary mb-20 text-center italic">Visual Poetry</h2>
    ...
    <section class="py-32 bg-primary relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto text-center px-8">
            <h2 class="font-headline text-5xl md:text-8xl text-white mb-10 italic leading-tight">Begin your
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                <button
                    class="bg-white text-primary px-12 py-5 rounded-full font-label text-sm tracking-widest uppercase font-bold hover:scale-105 transition-all shadow-xl">
                    Check Availability
                </button>
                <button
                    class="border border-white/30 text-white px-12 py-5 rounded-full font-label text-sm tracking-widest uppercase hover:bg-white/5 transition-all">
                    Contact Concierge
                </button>
            </div>
        </div>
    ...
    <!-- Footer -->
    <footer class="w-full py-20 border-t border-stone-200/20 dark:border-stone-800/20 bg-stone-100 dark:bg-stone-950">
        <div
            class="grid grid-cols-1 md:grid-cols-3 gap-16 px-8 max-w-7xl mx-auto text-center md:text-left items-start">
            <div class="space-y-6">
                <span class="font-serif text-2xl font-bold text-teal-900 dark:text-teal-50 italic">Chhapaak
                    Resort</span>
                <p class="text-stone-500 font-body text-sm max-w-xs mx-auto md:mx-0 leading-relaxed">An organic escape
                    designed for the modern explorer. Sustainably crafted, luxury defined.</p>
            ...
            <div class="grid grid-cols-2 gap-12">
                <div class="space-y-4">
                    <h4
                        class="font-sans text-xs tracking-[0.3em] uppercase text-teal-900 dark:text-teal-50 font-bold mb-8 opacity-50">
                        Explore</h4>
                    <ul class="space-y-4">
            ...
            <div class="space-y-6">
                <h4
                    class="font-sans text-xs tracking-[0.3em] uppercase text-teal-900 dark:text-teal-50 font-bold mb-8 opacity-50">
                    Newsletter</h4>
                <p class="text-stone-500 text-sm mb-6">Join our inner circle for exclusive offers and updates.</p>
                <div class="flex gap-2 border-b border-stone-300 dark:border-stone-800 pb-2">
                    <input class="bg-transparent border-0 px-0 py-2.5 text-sm w-full focus:ring-0"
                        placeholder="Email address" type="email" />
                    <button class="text-primary p-2 flex items-center justify-center">
                        <span class="material-symbols-outlined text-xl">north_east</span>
                    </button>
                </div>
            </div>
        </div>
        <div class="mt-20 text-center border-t border-stone-200/40 dark:border-stone-800/40 pt-10">
            <p class="font-sans text-[10px] tracking-[0.4em] uppercase text-stone-400">© 2024 Chhapaak Resort. All
                rights reserved.</p>
        </div>
    </footer>
</body>
