 ...
 <footer class="w-full py-16 border-t border-stone-200/20 dark:border-stone-800/20 bg-stone-100 dark:bg-stone-950">
     <div class="grid grid-cols-1 md:grid-cols-3 gap-12 px-8 max-w-7xl mx-auto text-center md:text-left items-start">
         <div class="space-y-6">
             {{-- <span class="font-serif text-xl font-bold text-teal-900 dark:text-teal-50">Chhapaak Resort</span> --}}
             <img alt="Chhapaak Resort" class="h-16 mx-auto md:mx-0" src="/assets/images/Chhapaak.png" />
